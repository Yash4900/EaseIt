...
class _MyVehicleState extends State<MyVehicle> {
  ...
  Future<void> findVehicle() async{
    await db.collection('Vehicle_Info')
    .get()
    .then((QuerySnapshot querySnapshot) {
        querySnapshot.docs.forEach((doc) {
            if(doc["flatNo"] == Globals().flatNo && doc["wing"] == Globals().wing){    
              foundVehicle = true;  
              document = doc;     
              vehicleNoController.text = doc["vehicleNo"];
              vehicleModelController.text = doc["model"];
        ...
        children: [
            ...
            // Container(child: Text("h"),):
              ...
              child: Center(child: Column(
                ...
                children: <Widget>[
                  Center(
                    child: Text("Hello ${g.fname}, enter below details to register your vehicle !",
                      style: TextStyle(
                        fontSize: 20,
                  ...
                  Center(
                    child: ElevatedButton(
                      ...
                      onPressed: () { 
                        uploadVehicleData(vehicleNoController.text, vehicleModelController.text, vehicleColorController.text, vehicleTypeController.text);                      
                      },
  ...
  Future<void> uploadVehicleData(String vehicleNo, String model, String color, String type){
    showDialog(
        context: context,
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                  top: 115,
                  left: 20,
                  child: Text("Your Vehicle", style: TextStyle(
                    fontSize: 20, color: Color(0xFF363f93), fontWeight: FontWeight.bold
                  ),),
                )
              ],
            ),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(widget.vehicleNo, style: TextStyle(
                          fontSize: 20,
                          color: Color(0xFF363f93),
                          fontWeight: FontWeight.bold
                        ),),
          ...
          Center(
            ...
            Row(
              ...
              style: ButtonStyle(
                ...
                backgroundColor: MaterialStateProperty.all<Color>(Color(0xFF363f93))
              ),
              onPressed: () { 
                Navigator.push(
                  context,
